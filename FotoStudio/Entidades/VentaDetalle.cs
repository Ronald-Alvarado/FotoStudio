...
namespace FotoStudio.Entidades
{
    public class VentaDetalle
    {
        ...
        [ValidarId] public int VentaId { get; set; }
        ...
        [Required(ErrorMessage = "Este campo no puede estar vacio.")]
        [ValidarCantidad] public int Cantidad { get; set; }

        [DisplayFormat(DataFormatString = "{0:C}")]
        [Required(ErrorMessage = "Este campo no puede estar vacio.")]
        [ValidarPrecio] public decimal PrecioArticulo { get; set; }
        ...
        [DisplayFormat(DataFormatString = "{0:C}")]
        [Required(ErrorMessage = "Este campo no puede estar vacio.")]
        [ValidarPrecio] public decimal PrecioEvento { get; set; }
